...
// Function to get rebounds for the player with the largest shoe size
...
console.log(shoeSize("Bismak Biyombo")); // Output: 16
...
console.log(playerStats("Ben Gordon")); // Output: Object containing Ben Gordon's stats
console.log(bigShoeRebounds()); // Output: Rebounds of the player with the largest shoe size